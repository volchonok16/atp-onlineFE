...
import { fetchStaffListThunk, setActiveStaffAC } from './model/staffReducer'
...
export const Staff = () => {
  ...
  const activeStaffHandler = (staff: StaffType) => {
  ...
  return (
    <div className={css.staff}>
      <div>
        ...
        <TableTools>
          <FuncButton
            disabled={!activeStaff.FIO_KEY}
            title={'Редактировать запись'}
          />
          <FuncButton title={'Добавить запись'} />
          <FuncButton disabled={!activeStaff.FIO_KEY} title={'Удалить'} />
        </TableTools>
      </div>
      <div className={css.activeRowData}>
        ...
        <div>
          ...
          <div className={css.categoriesContainer}>
            <div className={css.categories}>
              <label>
                <input type="checkbox" checked={!!activeStaff.KAT_A} disabled />
                А
              </label>
              <label>
                <input
            ...
            <div className={css.categories}>
              <label>
                <input type="checkbox" checked={!!activeStaff.KAT_B} disabled />
                B
              </label>
              <label>
                <input
            ...
            <div className={css.categories}>
              <label>
                <input type="checkbox" checked={!!activeStaff.KAT_C} disabled />
                C
              </label>
              <label>
                <input
            ...
            <div className={css.categories}>
              <label>
                <input type="checkbox" checked={!!activeStaff.KAT_D} disabled />
                D
              </label>
              <label>
                <input
        ...
        <div className={css.tractorLicense}>
          <label className={css.label}>
            ...
            <input type="text" defaultValue={activeStaff.UDOST_SPEC} readOnly />
          </label>
          <label className={css.label}>
            Срок действия
            <input
        ...
        <div>
          ...
          <div className={css.categoriesContainer}>
            ...
            <label>
              <input type="checkbox" checked={!!activeStaff.KAT_S_B} disabled />
              B
            </label>
            <label>
              <input type="checkbox" checked={!!activeStaff.KAT_S_C} disabled />
              C
            </label>
            <label>
              <input type="checkbox" checked={!!activeStaff.KAT_S_D} disabled />
              D
            </label>
            <label>
              <input type="checkbox" checked={!!activeStaff.KAT_S_F} disabled />
              F
            </label>
            <label>
              <input type="checkbox" checked={!!activeStaff.KAT_S_E} disabled />
              E
            </label>
          </div>
        </div>
